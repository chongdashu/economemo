...
def test_new_user_reads_multiple_articles(db: Session):
    ...
    article1_response = client.post(
        ...
        json={
            ...
            "date_last_accessed": "2023-12-01T10:30:00",
            "date_read": "2023-12-01T10:30:00",
        },
    )
    ...
    article2_response = client.post(
        ...
        json={
            ...
            "date_last_accessed": "2023-12-02T14:45:00",
            "date_read": "2023-12-02T14:45:00",
        },
    )
...
def test_user_marks_article_unread_then_read_again(db: Session):
    ...
    article_response = client.post(
        ...
        json={
            ...
            "date_last_accessed": "2023-12-05T09:30:00",
            "date_read": "2023-12-05T09:30:00",
        },
    )
    ...
    unread_response = client.patch(
        ...
        headers={"User-Id": user_id},
        json={"date_last_accessed": "2023-12-06T10:00:00", "date_read": None},
    )
    ...
    reread_response = client.patch(
        f"/articles/{article_id}",
        headers={"User-Id": user_id},
        json={"date_last_accessed": "2023-12-07T11:00:00", "date_read": "2023-12-07T11:30:00"},
    )
...
def test_user_accesses_article_multiple_times_before_reading(db: Session):
    ...
    second_access_response = client.patch(
        f"/articles/{article_id}",
        headers={"User-Id": user_id},
        json={"date_last_accessed": "2023-12-11T09:00:00", "date_read": None},
    )
    ...
    read_response = client.patch(
        f"/articles/{article_id}",
        headers={"User-Id": user_id},
        json={"date_last_accessed": "2023-12-12T10:00:00", "date_read": "2023-12-12T10:30:00"},
    )
    ...
    assert article["date_last_accessed"] == "2023-12-12T10:00:00"
...
def test_user_reads_article_from_multiple_devices(db: Session):
    ...
    laptop_response = client.patch(
        f"/articles/{article_id}",
        headers={"User-Id": user_id},
        json={"date_last_accessed": "2023-12-15T20:00:00", "date_read": "2023-12-15T20:30:00"},
    )
    assert laptop_response.status_code == 200

    # Access from third device (e.g., tablet) after reading
    tablet_response = client.patch(
        f"/articles/{article_id}", headers={"User-Id": user_id}, json={"date_last_accessed": "2023-12-16T10:00:00"}
    )
