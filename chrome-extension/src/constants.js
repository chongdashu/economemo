var WHITELISTED_SITES = [
    { 
      domain: 'yahoo.com', 
      articlePattern: /^https:\/\/(www\.)?(yahoo\.com\/news\/|news\.yahoo\.com\/).*(-\d+\.html|\.[a-zA-Z]+)$/
    },
    { 
      domain: 'cnn.com', 
      articlePattern: /^https:\/\/(edition\.)?cnn\.com\/\d{4}\/\d{2}\/\d{2}\/.*\/index\.html$/
    },
    { 
      domain: 'nytimes.com', 
    ...
    { 
      domain: 'bbc.com', 
      articlePattern: /^https:\/\/www\.bbc\.com\/(news|sport)\/(\w+\/)*\w+-\d+$/
    },
    { 
      domain: 'bbc.co.uk', 
      articlePattern: /^https:\/\/www\.bbc\.co\.uk\/(news|sport)\/(articles|live)\/[a-z0-9]+$/
    },
    { 
      domain: 'msn.com', 
    ...
    { 
      ...
      articlePattern: /^https:\/\/www\.economist\.com\/[a-z-]+\/\d{4}\/\d{2}\/\d{2}\/[a-z0-9-]+$/
    },
  ];
